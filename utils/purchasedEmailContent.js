...
<![endif]-->
  ...
  <![endif]-->
  ...
  </table><table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="1d7e35c1-7c0f-4382-adf1-6b5d4d36bd0b">
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:100% !important; width:100%; height:auto !important;" width="600" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/1fbfb976e8873f58/aaa3da0a-3103-4ccf-a130-dc70074529be/2701x342.png">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:60px 0px 0px 0px; line-height:30px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><h2 style="text-align: center">Thank you for your order!</h2><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 20px 30px 20px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #565656">Supplier will contact you for your purchases soon, stay tune.</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table>
  ${products.map(
    (
      product,
    ) => `  <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 0px 0px 0px;" bgcolor="#FFFFFF" data-distribution="1,1,1">
    <tbody>
      ...
      <tbody>
        <tr>
          <td style="padding:0px;margin:0px;border-spacing:0;"><table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="655bf2ff-12c0-40a0-b225-1ec005f36441">
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
      ...
      <tbody>
        <tr>
          <td style="padding:0px;margin:0px;border-spacing:0;"><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="100a6364-490f-455a-af08-d31999ad78f6">
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit">${product.name}</div>
<div style="font-family: inherit">$ ${product.price} x ${product.quantity}</div><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
        </tr>
  ...
  <table class="module" role="module" data-type="divider" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="5d3bd0da-303d-464d-a5b4-40e65048abde">
    <tbody>
      <tr>
        <td style="padding:30px 0px 0px 0px;" role="module-content" height="100%" valign="top" bgcolor="">
...
<div style="font-family: inherit; text-align: center"><span style="font-size: 12px; color: #565656">${purchasedDate}</span></div><div></div></div></td>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit; background-color:082214;" height="100%" valign="top" bgcolor="082214" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="white-space-collapse: preserve; text-wrap: wrap; color: #ffffff; font-size: 10px">8th Floor, OCIC Blvd, Sangkat Chroy Changvar, Khan Chroy</span></div>
<div style="font-family: inherit; text-align: center"><span style="white-space-collapse: preserve; text-wrap: wrap; color: #ffffff; font-size: 10px">Changvar Phnom Penh, Cambodia</span></div><div></div></div></td>
      </tr>
    </tbody>
  </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="9417dba6-a547-43dc-9d2d-61a7f3465965.1" data-mc-module-version="2019-10-22">
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:6px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="white-space-collapse: preserve; text-wrap: wrap; font-size: 10px; color: #828282">© All right reserved AgTeach - 2024 | Terms and Service | Privacy Policy</span></div><div></div></div></td>
      </tr>
    </tbody>
